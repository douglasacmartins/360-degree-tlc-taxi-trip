...
type SnakeCaseColumnName = Annotated[str, "Snake case columns names"]
type CanonicalColumnName = Annotated[str, "Canonical names for columns"]
type ColumnDescription = Annotated[str, "Description for columns"]
type Id = Annotated[int, "Identifier for categorical variables"]
